...
<style>
    ...
    .face {
        ...
        width: 100px;
        height: 100px;
        background: rgba(0, 123, 255, 0.1); /* Transparan untuk menunjukkan garis */
        border: 1px solid #007bff; /* Garis untuk tiap sisi */
...
<div class="container mt-5">
    <h3 class="box text-center">Interaktif Kubus Dimensi</h3>
    <div class="row">
